...
// func (r *postgresAddressesRepo) Update(addressId string, addressPartial domain.AddressPatch) (string, error) {
// 	// Construct the SQL query based on the fields provided in the AddressPartial object.
// 	query := "UPDATE addresses SET updated_at = NOW()"
// 	args := []interface{}{}

// 	if addressPartial.AddressLine1 != nil {
// 		query += ", address_line_1 = $1"
// 		args = append(args, *addressPartial.AddressLine1)
// 	}

// 	if addressPartial.AddressLine2 != nil {
// 		query += ", address_line_2 = $2"
// 		args = append(args, *addressPartial.AddressLine2)
// 	}

// 	if addressPartial.AddressLine3 != nil {
// 		query += ", address_line_3 = $3"
// 		args = append(args, *addressPartial.AddressLine3)
// 	}

// 	if addressPartial.City != nil {
// 		query += ", city = $4"
// 		args = append(args, *addressPartial.City)
// 	}

// 	if addressPartial.County != nil {
// 		query += ", county = $5"
// 		args = append(args, *addressPartial.County)
// 	}

// 	if addressPartial.State != nil {
// 		query += ", state = $6"
// 		args = append(args, *addressPartial.State)
// 	}

// 	if addressPartial.Postcode != nil {
// 		query += ", postcode = $7"
// 		args = append(args, *addressPartial.Postcode)
// 	}

// 	if addressPartial.Country != nil {
// 		query += ", country = $8"
// 		args = append(args, *addressPartial.Country)
// 	}

// 	query += " WHERE id = $9 AND deleted_at IS NULL"

// 	// Execute the SQL query and check the number of affected rows.
// 	result, err := r.conn.ExecContext(context.Background(), query, args...)
// 	if err != nil {
// 		return "", fmt.Errorf("error in update method: %v", err)
// 	}

// 	numberOfAffectedRows, err := result.RowsAffected()
// 	if err != nil {
// 		return "", fmt.Errorf("error in update method when checking RowsAffected(): %v", err)
// 	}
...
// 	// Fetch the updated address from the database and return it along with no error.
// 	updatedAddress, err := r.getById(addressId)
// 	if err != nil {
// 		return "", fmt.Errorf("error in update method when fetching updated address: %v", err)
// 	}
